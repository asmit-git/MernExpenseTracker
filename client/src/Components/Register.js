                ...
                <div className="mx-auto h-full sm:w-max my-20">
                    <div className="m-auto py-12">
                        <div className="mt-12 rounded-3xl border bg-gray-50 dark:border-gray-700 dark:bg-gray-800 -mx-6 sm:-mx-10 p-8 sm:p-10">
                            <h3 className="text-2xl font-semibold text-gray-700 dark:text-white">Register</h3>
                            <form onSubmit={handleSubmit} className="mt-10 space-y-8 dark:text-white">
                                ...
                                <div>
                                    ...
                                    <NavLink href="/login" type="reset" className="-ml-3 w-max p-3">
                                        <span className="text-sm tracking-wide text-fuchsia-600 dark:text-fuchsia-400">Alerady an User? Login</span>
                                    </NavLink>
                                </div>
                            </form>
                        </div>
